...
// ── the fake NAS ───────────────────────────────────────────────────────────
// The WebDAV server this suite drives — and the self-signed certificate a
// Synology reached by its tailnet name presents — live in scripts/fake-webdav.js
// since 2026-09-17, so the smoke suite can point lib/backup.js at the same
// wedging NAS. One fake, driven from both suites, cannot drift from itself.
const { makeDavServer, listen, close, TEST_CERT, TEST_KEY } = require('./fake-webdav');
